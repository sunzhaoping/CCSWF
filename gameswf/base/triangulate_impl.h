...
struct poly_vert
{
	...
	void	remap(const gameswf::array<int>& remap_table)
	{
...
template<class coord_t>
inline bool	edges_intersect_sub(const gameswf::array<poly_vert<coord_t> >& sorted_verts, int e0v0, int e0v1, int e1v0, int e1v1)
...
template<>
inline bool	edges_intersect_sub(const gameswf::array<poly_vert<float> >& sorted_verts, int e0v0i, int e0v1i, int e1v0i, int e1v1i)
// Return true if edge (e0v0,e0v1) intersects (e1v0,e1v1).
//
...
template<>
inline bool	edges_intersect_sub(const gameswf::array<poly_vert<sint32> >& sorted_verts, int e0v0i, int e0v1i, int e1v0i, int e1v1i)
// Return true if edge (e0v0,e0v1) intersects (e1v0,e1v1).
//
...
template<class coord_t>
bool	edges_intersect(const gameswf::array<poly_vert<coord_t> >& sorted_verts, int e0v0, int e0v1, int e1v0, int e1v1)
// Return true if edge (e0v0,e0v1) intersects (e1v0,e1v1).
{
...
template<class coord_t>
bool	is_convex_vert(const  gameswf::array<poly_vert<coord_t> >& sorted_verts, int vi)
...
struct poly
{
	...
	poly(/*@@ TODO  gameswf::array<vert_t>* sorted_verts*/)
		:
	...
	bool	is_valid(const  gameswf::array<vert_t>& sorted_verts, bool check_consecutive_dupes = true) const;

	// init/prep
	void	append_vert(gameswf::array<vert_t>* sorted_verts, int vert_index);
	void	remap(const  gameswf::array<int>& remap_table);
	void	remap_for_duped_verts(const  gameswf::array<vert_t>& sorted_verts, int v0, int v1);

	void	init_edge_index(const  gameswf::array<vert_t>& sorted_verts, index_box<coord_t>& bound_of_all_verts);
	int	find_valid_bridge_vert(const  gameswf::array<vert_t>& sorted_verts, int v1);
	void	update_connected_sub_poly(gameswf::array<vert_t>* sorted_verts, int v_start, int v_stop);
	void	init_for_ear_clipping(gameswf::array<vert_t>* sorted_verts);

	// Edges are indexed using their first vert (i.e. edge (v1,v2) is indexed using v1)
	void	add_edge(const  gameswf::array<vert_t>& sorted_verts, int vi);
	void	remove_edge(const  gameswf::array<vert_t>& sorted_verts, int vi);

	// tests/queries
	bool	any_edge_intersection(const  gameswf::array<vert_t>& sorted_verts, int external_vert, int v2);
	bool	vert_can_see_cone_a(const  gameswf::array<vert_t>& sorted_verts, int v, int cone_a_vert, int cone_b_vert);
	bool	vert_in_cone(const  gameswf::array<vert_t>& sorted_verts, int vert, int cone_v0, int cone_v1, int cone_v2);
	bool	vert_is_duplicated(const  gameswf::array<vert_t>& sorted_verts, int v0);
	bool	ear_contains_reflex_vertex(const  gameswf::array<vert_t>& sorted_verts, int v0, int v1, int v2);

	void	classify_vert(gameswf::array<vert_t>* sorted_verts, int vi);
	void	dirty_vert(gameswf::array<vert_t>* sorted_verts, int vi);

	int	get_vertex_count() const { return m_vertex_count; }
	int	get_ear_count() const { return m_ear_count; }
	int	get_next_ear(const  gameswf::array<vert_t>& sorted_verts, tu_random::generator* rg);
	int	remove_degenerate_chain(gameswf::array<vert_t>* sorted_verts, int vi);
	void	emit_and_remove_ear(gameswf::array<coord_t>* result,  gameswf::array<vert_t>* sorted_verts, int v0, int v1, int v2);
	bool	build_ear_list(gameswf::array<vert_t>* sorted_verts, tu_random::generator* rg);

	void	invalidate(const  gameswf::array<vert_t>& sorted_verts);

//data:
//@@ TODO	 gameswf::array<vert_t>*	m_sorted_verts;
...
template<class coord_t>
bool	poly<coord_t>::is_valid(const  gameswf::array<vert_t>& sorted_verts, bool check_consecutive_dupes /* = true */) const
// Assert validity.
{
#ifndef NDEBUG
...
template<class coord_t>
void	poly<coord_t>::invalidate(const  gameswf::array<vert_t>& sorted_verts)
...
template<class coord_t>
void	poly<coord_t>::append_vert(gameswf::array<vert_t>* sorted_verts, int vert_index)
...
template<class coord_t>
int	poly<coord_t>::find_valid_bridge_vert(const  gameswf::array<vert_t>& sorted_verts, int v1)
...
template<class coord_t>
void	poly<coord_t>::remap(const  gameswf::array<int>& remap_table)
{
	assert(m_loop > -1);
	assert(m_leftmost_vert > -1);
...
template<class coord_t>
void	poly<coord_t>::remap_for_duped_verts(const  gameswf::array<vert_t>& sorted_verts, int v0, int v1)
...
template<class coord_t>
void	poly<coord_t>::classify_vert(gameswf::array<vert_t>* sorted_verts, int vi)
...
template<class coord_t>
void	poly<coord_t>::dirty_vert(gameswf::array<vert_t>* sorted_verts, int vi)
...
template<class coord_t>
bool	poly<coord_t>::build_ear_list(gameswf::array<vert_t>* sorted_verts, tu_random::generator* rg)
...
template<class coord_t>
int	poly<coord_t>::get_next_ear(const  gameswf::array<vert_t>& sorted_verts, tu_random::generator* rg)
...
void	poly<coord_t>::emit_and_remove_ear(
	 gameswf::array<coord_t>* result,
	 gameswf::array<vert_t>* sorted_verts,
	int v0,
	int v1,
	int v2)
...
template<class coord_t>
int	poly<coord_t>::remove_degenerate_chain(gameswf::array<vert_t>* sorted_verts, int vi)
...
template<class coord_t>
void	poly<coord_t>::update_connected_sub_poly(gameswf::array<vert_t>* sorted_verts, int v_first_in_subloop, int v_first_after_subloop)
...
template<class coord_t>
void	poly<coord_t>::init_edge_index(const  gameswf::array<vert_t>& sorted_verts, index_box<coord_t>& bound_of_all_verts)
...
template<class coord_t>
void	poly<coord_t>::init_for_ear_clipping(gameswf::array<vert_t>* sorted_verts)
...
template<class coord_t>
void	poly<coord_t>::add_edge(const  gameswf::array<vert_t>& sorted_verts, int vi)
...
template<class coord_t>
void	poly<coord_t>::remove_edge(const  gameswf::array<vert_t>& sorted_verts, int vi)
...
template<class coord_t>
bool	poly<coord_t>::vert_can_see_cone_a(const  gameswf::array<vert_t>& sorted_verts, int v, int cone_a_vert, int cone_b_vert)
...
template<class coord_t>
bool	poly<coord_t>::any_edge_intersection(const  gameswf::array<vert_t>& sorted_verts, int external_vert, int my_vert)
...
template<class coord_t>
bool	poly<coord_t>::ear_contains_reflex_vertex(const  gameswf::array<vert_t>& sorted_verts, int v0, int v1, int v2)
...
template<class coord_t>
bool	poly<coord_t>::vert_in_cone(const  gameswf::array<vert_t>& sorted_verts, int vert, int cone_v0, int cone_v1, int cone_v2)
...
template<class coord_t>
bool	poly<coord_t>::vert_is_duplicated(const  gameswf::array<vert_t>& sorted_verts, int vert)
...
{
//data:
	 gameswf::array<poly_vert<coord_t> >	m_sorted_verts;
	 gameswf::array<poly<coord_t>*>	m_polys;

	index_box<coord_t>	m_bound;
	int	m_estimated_triangle_count;

//code:
	void	init(int path_count, const  gameswf::array<coord_t> paths[]);
...
template<class coord_t>
void	poly_env<coord_t>::init(int path_count, const  gameswf::array<coord_t> paths[])
...
// and component polys.
{
	...
	for (int i = 0; i < path_count; i++)
	{
		...
		const  gameswf::array<coord_t>&	path = paths[i];
	...
	// of two verts.
	 gameswf::array<int>	vert_remap;	// vert_remap[i] == new index of original vert[i]
...
static void	recovery_process(
	 gameswf::array<poly<coord_t>*>* polys,	// polys waiting to be processed
	poly<coord_t>* P,	// current poly
	 gameswf::array<poly_vert<coord_t> >* sorted_verts,
...
inline void	debug_emit_poly_loop(
	 gameswf::array<coord_t>* result,
	const  gameswf::array<poly_vert<coord_t> >& sorted_verts,
	poly<coord_t>* P)
...
static void compute_triangulation(
	 gameswf::array<coord_t>* result,
	int path_count,
	const  gameswf::array<coord_t> paths[],
	int debug_halt_step,
	 gameswf::array<coord_t>* debug_edges)
...
void	recovery_process(
	 gameswf::array<poly<coord_t>*>* polys,
	poly<coord_t>* P,
	 gameswf::array<poly_vert<coord_t> >* sorted_verts,
	tu_random::generator* rg)
{
