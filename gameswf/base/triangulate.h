...
namespace triangulate
{
	...
	void	compute(
		gameswf::array<sint16>* results,	// indexed trilist
		int path_count,
	...
	void	compute(
		gameswf::array<sint32>* results,	// indexed trilist
		int path_count,
		const gameswf::array<sint32> paths[],
		int debug_halt_step = -1,
		gameswf::array<sint32>* debug_remaining_loop = NULL);
}
