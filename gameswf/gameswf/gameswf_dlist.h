...
namespace gameswf
{
	...
	struct display_list
	{
		...
		character*	get_character_by_name(const  gameswf::tu_string& name);
		...
		void clear_unaffected(gameswf::array<int>& affected_depths);
		...
		void dump( gameswf::tu_string& tabs);

	private:

		void remove(int index);
		 gameswf::array<display_object_info> m_display_object_array;
	};
