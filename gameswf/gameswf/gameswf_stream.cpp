...
//		IF_DEBUG(log_msg("val = 0x%X\n", val));
	...
	void stream::read_string( gameswf::tu_string* str)
	{
		align();
		str->resize(0);
	...
	void	stream::read_string_with_length( gameswf::tu_string* str)
	{
		align();
		str->resize(0);
	...
	void	stream::read_string_with_length(int len,  gameswf::tu_string* str)
	{
//???		align();
		str->resize(0);
