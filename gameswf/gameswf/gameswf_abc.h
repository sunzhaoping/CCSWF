...
namespace gameswf
{
	...
	{
		// constant pool
		 gameswf::array<int> m_integer;
		 gameswf::array<Uint32> m_uinteger;
		 gameswf::array<double> m_double;
		 gameswf::array< gameswf::tu_string> m_string;
		 gameswf::array<namespac> m_namespace;
		 gameswf::array<  gameswf::array<int> > m_ns_set;
		 gameswf::array<multiname> m_multiname;

//		 gameswf::array<gc_ptr<method_info> > m_method;
		...
		as_function* get_script_function( const  gameswf::tu_string & name = "" ) const;
		...
		inline const char * get_super_class( gameswf::tu_string& name) const
		{
		...
		as_function* get_class_constructor(const  gameswf::tu_string& name) const;

		// find instance info by name
		instance_info* get_instance_info(const  gameswf::tu_string& class_name) const;
		class_info* get_class_info(const  gameswf::tu_string& full_class_name) const;
