...
namespace gameswf
{
	...
	struct button_action
	{
		...
		int	m_conditions;
		 gameswf::array<action_buffer*>	m_actions;
	...
	struct button_character_definition : public character_def
	{
		struct sound_info
		{
			...
			Uint32 m_out_point;
			Uint16 m_loop_count;
			 gameswf::array<sound_envelope> m_envelopes;
		};
		...
		bool m_menu;
		 gameswf::array<button_record>	m_button_records;
		 gameswf::array<button_action>	m_button_actions;
