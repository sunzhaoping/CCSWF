...
namespace gameswf
{
	...
	{
#ifdef WIN32
	static  gameswf::tu_string s_gameswf_version("WIN "__DATE__" "__TIME__);
#else
        static  gameswf::tu_string s_gameswf_version( gameswf::tu_string("LINUX ") +__DATE__+" "+__TIME__);
#endif
	...
	{
		registered_type_node(const  gameswf::tu_string& classname, gameswf_module_init type_init_func) :
			m_next(NULL),
		...
		registered_type_node *m_next;
		 gameswf::tu_string             m_classname;
		gameswf_module_init   m_type_init;
	};

	static registered_type_node* s_registered_types = NULL;

	void register_type_handler(const  gameswf::tu_string& type_name, gameswf_module_init type_init_func )
	{
	...
	gameswf_module_init find_type_handler(const  gameswf::tu_string& type_name)
	{
		registered_type_node *node = s_registered_types;
		while(node)
		{
	...
	static const  gameswf::tu_string	s_property_names[] =
	{
		 gameswf::tu_string("_x"),
		 gameswf::tu_string("_y"),
		 gameswf::tu_string("_xscale"),
		 gameswf::tu_string("_yscale"),
		 gameswf::tu_string("_currentframe"),
		 gameswf::tu_string("_totalframes"),
		 gameswf::tu_string("_alpha"),
		 gameswf::tu_string("_visible"),
		 gameswf::tu_string("_width"),
		 gameswf::tu_string("_height"),
		 gameswf::tu_string("_rotation"),
		 gameswf::tu_string("_target"),
		 gameswf::tu_string("_framesloaded"),
		 gameswf::tu_string("_name"),
		 gameswf::tu_string("_droptarget"),
		 gameswf::tu_string("_url"),
		 gameswf::tu_string("_highquality"),
		 gameswf::tu_string("_focusrect"),
		 gameswf::tu_string("_soundbuftime"),
		 gameswf::tu_string("mysteryquality"), // gameswf::tu_string("@@ mystery quality member"),  //this seems like a stupid bug to me . . . but I don't want it accessing the heap yet.
		 gameswf::tu_string("_xmouse"),
		 gameswf::tu_string("_ymouse"),
	};
	...
	void player::set_flash_vars(const  gameswf::tu_string& param)
	...
	movie_definition*	player::create_movie(const char* filename)
	{
		...
		if (m && s_use_cache_files)
		{
			// Try to load a .gsc file.
			 gameswf::tu_string	cache_filename(filename);
			cache_filename += ".gsc";
