...
namespace gameswf
{
	...
	struct stream
	{
		...
		void	read_string( gameswf::tu_string* str);	

		// For string that begins with an 8-bit length code.
		void	read_string_with_length( gameswf::tu_string* str);

		// For variable-length string, flash9
		void	read_string_with_length(int len,  gameswf::tu_string* str);
	...
	private:
		...
		Uint8	m_unused_bits;
		 ...
		 gameswf::array<int>	m_tag_stack;	// position of end of tag
	};
