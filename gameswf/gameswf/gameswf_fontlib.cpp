...
namespace gameswf
{
	...
	static  gameswf::array<recti>	s_covered_rects;
	...
	static  gameswf::array<pointi>	s_anchor_points;
	...
	bitmap_info* glyph_provider_tu::get_char_image(character_def* shape_glyph, Uint16 xcode, 
			const  gameswf::tu_string& fontname, bool is_bold, bool is_italic, int fontsize,
