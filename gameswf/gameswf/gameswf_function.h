...
namespace gameswf
{
	...
	struct as_s_function : public as_function
	{
		...
		action_buffer	m_action_buffer;
		 ...
		 gameswf::array<with_stack_entry>	m_with_stack;	// initial with-stack on function entry.
		int	m_start_pc;
		int	m_length;
		struct arg_spec
		{
		...
		as_s_function(player* player,
			const action_buffer* ab, int start, const  gameswf::array<with_stack_entry>& with_stack);
		~as_s_function();
