...
namespace gameswf
{
	...
	struct as_object : public as_object_interface
	{
		...
		exported_module virtual bool watch(const  gameswf::tu_string& name, as_function* callback, const as_value& user_data);
		exported_module virtual bool unwatch(const  gameswf::tu_string& name);
		...
		exported_module virtual void dump( gameswf::tu_string& tabs);
