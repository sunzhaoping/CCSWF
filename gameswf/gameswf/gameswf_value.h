...
namespace gameswf
{
	...
	struct as_value
	{
		...
		mutable  gameswf::tu_string	m_string;
		union
		{
			double m_number;
			bool m_bool;
	...
	public:
		...
		exported_module const  gameswf::tu_string&	to_tu_string() const;
		...
		exported_module void	set_tu_string(const  gameswf::tu_string& str);
		...
		bool find_property(const  gameswf::tu_string& name, as_value* val);
		bool find_property_owner(const  gameswf::tu_string& name, as_value* val);
