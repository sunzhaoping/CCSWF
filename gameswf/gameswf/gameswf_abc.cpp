...
namespace gameswf
{
	...
	as_function* abc_def::get_class_constructor(const  gameswf::tu_string& name) const
	{
	...
	instance_info* abc_def::get_instance_info(const  gameswf::tu_string& full_class_name) const
	{
		//TODO: implement namespace

		// find name
		 gameswf::tu_string class_name = full_class_name;
		...
		{
			const  gameswf::tu_string& name = get_multiname(m_instance[i]->m_name);
			if (class_name == name)
			{
	...
	class_info* abc_def::get_class_info(const  gameswf::tu_string& full_class_name) const
	{
		//TODO: implement namespace
	...
	as_function* abc_def::get_script_function( const  gameswf::tu_string & name ) const
	{
		if( name == "" )
